...
let back = tween.back.co;

/**
 *
 */

let o1; let o2; let o3; let animLength = 500;

let conf1 = {src: require('images/x.png'), sx: 650, ex: 561, y: 5, w: 22, h: 19};
let conf2 = {src: require('images/xx.png'), sx: 671, ex: 582, y: 5, w: 27, h: 26};
let conf3 = {src: require('images/xxx.png'), sx: 697, ex: 608, y: 6, w: 31, h: 32};
...
function createPosShow( x ) {
	let image = layer.createImage( 'default', require('images/lose.png'), x - 27, 406, 54, 50 ).scale( 1e-5, 1e-5 );
	let duration = 500;
